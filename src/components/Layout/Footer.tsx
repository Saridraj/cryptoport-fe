...
const Footer = ({}) => {
  return (
    <>
      <footer className="md:flex justify-between items-center h-fit md:h-[550px] lg:h-[450px] w-full bg-primary rounded-t-[48px]  shadow-black  shadow-[0_-15px_30px_-15px] p-[40px] md:p-[84px]  md:px-[108px]">
        <div className="md:w-[40%] h-[200px] md:h-full md:mx-1 ">
        ...
        <div className="md:w-[40%]  md:h-full mx-1">
          ...
          <div className="my-[24px] text-white text-[14px] md:text-[16px]">
